...
export default function CGSPro() {
  return (
    <LegalLayout title="Conditions Générales de Services — Vendeurs Professionnels" version="Version du 29-09-2025">
      <InfoBox color="green">
        <strong>DANIEL PARTNERS</strong> édite et exploite la marketplace SwingMarket accessible à l'adresse <strong>www.swingmarket.fr</strong>. Par le biais de la Plateforme, DANIEL PARTNERS permet de mettre en relation des Vendeurs Professionnels de matériel de golf avec des Clients consommateurs.
      </InfoBox>
      ...
      <div className="mt-8 space-y-2">
        ...
        <Section title="ARTICLE 13. SUSPENSION ET RÉSILIATION">
          ...
          <SubSection title="13.2. Résiliation par le Vendeur">
            <p>Le Vendeur peut résilier le présent Contrat à tout moment en contactant DANIEL PARTNERS à <a href="mailto:contact@swingmarket.fr" className="text-[#1B5E20] hover:underline">contact@swingmarket.fr</a> avec un préavis de quinze (15) jours. La résiliation prend effet après traitement des Commandes en cours.</p>
          </SubSection>
